...
public final class CommandParameter {
    ...
    public static final String GO_TO_INDEX_PAGE = "Controller?command=gotoindexpage";
    public static final String GO_TO_APPOINT_NEXT_PAGE = "Controller?command=gotoaddappointmentnextpage";
    public static final String GO_TO_STAFF_PAGE = "Controller?command=gotomainstaffpage";
    public static final String GO_TO_PATIENT_PAGE = "Controller?command=gotomainpatientpage";
    ...
    public static final String WRONG_AUTH ="wrong auth";
